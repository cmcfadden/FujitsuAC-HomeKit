...
Use the "+" button in the HomeKit application and select "add accessory". Tap the button to find other devices and select the AC. The default pairing code is 466-37-726 (you can change the pairing code over serial).

The accessory will present two "Fans" - the first one controls the actual fan speed of the unit, and Fan 2 controls the vertical slats (vanes). 
